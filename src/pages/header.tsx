...
const HeaderBox: React.FC<Props> = ({ onAnimationEnd }) => {
    ...
    return (
        <div ref={headerRef} className="fixed flex flex-col mb-8">
            <p className="font-kitchen text-7xl animate__animated animate__zoomInDown">
                Sales
            </p>
            <p className="font-kitchen text-7xl animate__animated animate__zoomInUp text-lime-400">
                Tracker
            </p>
